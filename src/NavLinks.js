  ...
  return (
    <>
      <button className="jss7" style={{ cursor: 'pointer' }} onClick={toggle}>
        <span icon="selection" aria-hidden="true" className="bp3-icon bp3-icon-selection">
      ...
      <div className="jss6" style={{ height: jss6 }}>
        <NavLink to="mint" className={(isActive) => 'menuItem' + (!isActive ? ' unselected' : '')}>
          <svg
        ...
        <NavLink
          to="config"
          className={(isActive) => 'menuItem' + (!isActive ? ' unselected' : '')}
        >
          {' '}
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <NavLink to="docs" className={(isActive) => 'menuItem' + (!isActive ? ' unselected' : '')}>
          {' '}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
